...
enum Theme {
    ...
    // A warm red for a nearly-spent context window (auto-compact imminent, quality already
    // degrading) — the ring's "compact now" signal.
    static let red = Color(.sRGB, red: 0.93, green: 0.42, blue: 0.38, opacity: 1)
